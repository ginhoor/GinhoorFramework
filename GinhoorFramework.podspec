#
#  Be sure to run `pod spec lint GinFramework.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of GinFramework in Markdown format.
  ...
  # CSDN Code配置
  #s.source       = { :git => "git@code.csdn.net:Ginhoor/ginframework.git", :tag => s.version.to_s }
  # 手动管理版本
  #s.source       = { :git => "/Users/junhuashao/iOS/Workspace/ginframework", :tag => s.version.to_s }
