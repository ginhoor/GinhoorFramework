...
+ (void)alertOnWindow:(UIWindow * __nullable)window title:(NSString * __nullable)title message:(NSString * __nullable)message cancelTitle:(NSString * __nullable)cancelTitle cancleBtnStyle:(UIAlertActionStyle)cancelBtnStyle cancelBlock:(void (^)(UIAlertAction *action))cancelBlock completionBlock:(void(^)(void))completionBlock;

+ (void)alertOnWindow:(UIWindow * __nullable)window title:(NSString * __nullable)title message:(NSString * __nullable)message submitTitle:(NSString * __nullable)submitTitle submitBtnStyle:(UIAlertActionStyle)submitBtnStyle submitBlock:(void (^)(UIAlertAction *action))submitBlock cancelTitle:(NSString * __nullable)cancelTitle cancleBtnStyle:(UIAlertActionStyle)cancelBtnStyle cancelBlock:(void (^)(UIAlertAction *action))cancelBlock completionBlock:(void(^)(void))completionBlock;
